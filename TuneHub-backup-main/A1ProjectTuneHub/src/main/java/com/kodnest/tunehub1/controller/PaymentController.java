...
import com.kodnest.tunehub1.service.UserService;
...
public class PaymentController {
	...
	public String createOrder(HttpSession session) {
		...
		Order order=null;
		try {
			RazorpayClient razorpay=new RazorpayClient("rzp_test_C95SwCdNxG4Yj9", "UY1xo6HsgsDqjXF7MnucRGsT");
...
//			userService.updateUser(user);
	...
	public boolean verifyPayment(@RequestParam  String orderId, @RequestParam String paymentId,
	    ...
	    try {
	        ...
	        RazorpayClient razorpayClient = new RazorpayClient("rzp_test_C95SwCdNxG4Yj9", 
	        								"UY1xo6HsgsDqjXF7MnucRGsT");
